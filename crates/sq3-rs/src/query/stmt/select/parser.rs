...
impl<'a> SelectParser<'a, BeforeSelect> {
    pub(crate) fn select(mut self) -> SqliteResult<SelectParser<'a, AfterSelect>> {
        use crate::query::keyword::KeywordSelect;
        dbg!(self.remaining()?);
...
impl<'a> SelectParser<'a, AfterSelect> {
    pub(crate) fn distinct(mut self) -> SqliteResult<SelectParser<'a, AfterDistinct>> {
        use crate::query::{
...
impl<'a> SelectParser<'a, AfterDistinct> {
    pub(crate) fn result_columns(mut self) -> SqliteResult<SelectParser<'a, AfterFrom>> {
...
impl<'a> SelectParser<'a, AfterFrom> {
    pub(crate) fn table(mut self) -> SqliteResult<SelectParser<'a, AfterWhere>> {
...
impl<'a> SelectParser<'a, AfterWhere> {
    pub(crate) fn condition(mut self) -> SqliteResult<SelectParser<'a, Complete>> {
